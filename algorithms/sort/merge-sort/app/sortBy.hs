...
import MergeSortImBy (mergesortimBy)
import Data.List
...
--	print . last $ {-# SCC "MergeSortIm.mergesortim" #-} mergesortim sample1
	print . last $ {-# SCC "Data.List.sort_1000" #-} sortBy cmp (sampleN 1000)
	print . last $ {-# SCC "MergeSortIm.mergesortim_1000" #-} mergesortimBy cmp (sampleN 1000)
