{-# LANGUAGE FlexibleContexts, ScopedTypeVariables, AllowAmbiguousTypes #-}
...
sieveM :: forall a m . (MArray a Bool m, MonadFail m) => Int -> m [Int]
sieveM n | n < 2 = error "sieveIo n: n should be larger than 1"
sieveM n = do
