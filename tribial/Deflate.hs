{-# LANGUAGE OverloadedStrings, BinaryLiterals, TupleSections #-}
{-# OPTIONS_GHC -Wall -fno-warn-tabs #-}

module Deflate (uncompress) where
...
import Data.List (
	partition, intercalate, groupBy, sort, sortBy )
...
uncompress :: BS.ByteString -> Maybe (BS.ByteString, BS.ByteString)
uncompress bs = second fromBitArray <$> analyzeBlocks `runStateT` toBitArray bs
