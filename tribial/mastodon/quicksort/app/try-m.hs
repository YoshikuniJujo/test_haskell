...
--	xs <- mkSample' (0, 10 ^ i10) (13 * 10 ^ i4) -- sz
	...
	showTime' h gr 23 "quicksort (m = 23)    " (2 ^ i21) (readLast $ quicksortM 23 xs)
	showTime' h gr 28 "quicksort (m = 28)    " (2 ^ i21) (readLast $ quicksortM 28 xs)
	showTime' h gr 37 "quicksort (m = 37)    " (2 ^ i21) (readLast $ quicksortM 37 xs)
	showTime' h gr 50 "quicksort (m = 50)    " (2 ^ i21) (readLast $ quicksortM 50 xs)
	showTime' h gr 65 "quicksort (m = 65)    " (2 ^ i21) (readLast $ quicksortM 65 xs)
