...
data B1 = B1 { zero :: Int, length1 :: Int, body :: BS.ByteString } deriving Show
...
toByteString1 ba@B1 { zero = z, length1 = ln, body = bs } = case (z, ln `mod` 8) of
