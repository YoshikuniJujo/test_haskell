...
word5sToWord8s :: MonadFail m => [Word5] -> m [Word8]
...
word40sToWord8s :: MonadFail m => [Word40] -> Int -> m [Word8]
...
handleTail40To8 :: MonadFail m => Word40 -> Int -> m [Word8]
handleTail40To8 w40 n = if checkTail40 w40 n'
	then pure $ getWord8FromWord40 w40 <$> [4, 3 .. 4 - m + 1]
	else fail "word5sToWord8s: bad padding"
	where
