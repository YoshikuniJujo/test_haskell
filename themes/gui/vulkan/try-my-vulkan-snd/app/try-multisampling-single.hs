...
createSwapChain win sfc phdvc qfis dvc f = do
	...
	Vk.T.formatToType fmt \(_ :: Proxy fmt) -> do
		...
		Vk.Khr.Swapchain.createNew @'Nothing @_ @_ @fmt dvc crInfo nil nil \sc -> f sc scifmt ext
...
recreateSwapChain win sfc phdvc qfis0 dvc sc = do
	...
	ext <$ Vk.Khr.Swapchain.recreateNew @'Nothing @_ @_ @scfmt dvc crInfo nil nil sc
