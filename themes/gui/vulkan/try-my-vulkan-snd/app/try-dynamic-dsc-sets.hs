...
prepareMems :: (
	...
	V.Vector W1 -> V.Vector W2 -> V.Vector W3 -> (forall sds sm1 sb1 sm2 sb2 sm3 sb3 .
		...
		Vk.Mm.M sm1 '[ '( sb1, 'Vk.Mm.K.BufferArg "" '[VObj.DynList 2 256 W1 ""])] ->
		Vk.Mm.M sm2 '[ '( sb2, 'Vk.Mm.K.BufferArg "" '[VObj.DynList 2 256 W2 ""])] ->
		Vk.Mm.M sm3 '[ '( sb3, 'Vk.Mm.K.BufferArg "" '[VObj.DynList 2 256 W3 ""])] -> IO a) -> IO a
...
storageBufferNew :: forall sd nm w a . Storable w =>
	Vk.Dvc.D sd -> Vk.PhDvc.P -> V.Vector w -> (forall sb sm .
		...
		Vk.Mm.M sm '[ '(sb, 'Vk.Mm.K.BufferArg nm '[VObj.DynList 2 256 w ""])] ->
		IO a) -> IO a
...
writeDscSet ::
	...
	VObj.Offset ('VObj.Dynamic 2 (KObj.List 256 W1 "")) objs1,
	VObj.Offset ('VObj.Dynamic 2 (KObj.List 256 W2 "")) objs2,
	VObj.Offset ('VObj.Dynamic 2 (KObj.List 256 W3 "")) objs3
	) =>
...
writeDscSet ds ba bb bc = Vk.DscSet.Write {
	...
	Vk.DscSet.writeSources = Vk.DscSet.BufferInfos $
		U4 (Vk.Dsc.BufferInfo @_ @_ @_ @(VObj.DynList 2 256 W1 "") ba) :**
		U4 (Vk.Dsc.BufferInfo @_ @_ @_ @(VObj.DynList 2 256 W2 "") bb) :**
		U4 (Vk.Dsc.BufferInfo @_ @_ @_ @(VObj.DynList 2 256 W3 "") bc) :**
		HeteroParList.Nil }
