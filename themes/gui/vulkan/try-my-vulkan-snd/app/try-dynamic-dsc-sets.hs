...
writeDscSet ::
	...
	VObj.ObjectLengthIndex (VObj.DynList 2 256 W1 "") objs1,
	VObj.ObjectLengthIndex (VObj.DynList 2 256 W2 "") objs2,
	VObj.ObjectLengthIndex (VObj.DynList 2 256 W3 "") objs3
	) =>
...
writeDscSet ds ba bb bc = Vk.DscSet.WriteNew {
	...
	Vk.DscSet.writeSourcesNew = Vk.DscSet.BufferInfosNew $
		U4 (Vk.Dsc.BufferInfoNew @_ @_ @_ @(VObj.DynList 2 256 W1 "") ba) :**
		U4 (Vk.Dsc.BufferInfoNew @_ @_ @_ @(VObj.DynList 2 256 W2 "") bb) :**
		U4 (Vk.Dsc.BufferInfoNew @_ @_ @_ @(VObj.DynList 2 256 W3 "") bc) :**
		HeteroParList.Nil }
