...
run w inst g =
	...
	createSwapChainNew w sfc phdv qfis dv
		\(sc :: Vk.Khr.Swapchain.S ss scifmt) ext ->
	...
	createPipelineLayout' dv txsmplr \dscslyt ppllyt ->
...
createSwapChainNew :: Glfw.Window -> Vk.Khr.Surface.S ssfc -> Vk.PhDvc.P ->
	...
	(forall ss scfmt . Vk.T.FormatToValue scfmt =>
		Vk.Khr.Swapchain.S ss scfmt -> Vk.Extent2d -> IO a) ->
	IO a
...
recreateSwapChain :: forall ssfc sd ssc scfmt .
	...
	QueueFamilyIndices -> Vk.Dvc.D sd -> Vk.Khr.Swapchain.S ssc scfmt ->
	IO Vk.Extent2d
...
createDescriptorSetLayout :: forall sd ss s a .
	...
	Vk.DscSetLyt.L s '[
		...
		'Vk.DscSetLyt.ImageSampler '[ '("texture", 'Vk.T.FormatR8g8b8a8Srgb, ss)] ]
	-> IO a) -> IO a
createDescriptorSetLayout dvc smplr = Vk.DscSetLyt.create dvc layoutInfo nil'
	where
...
createPipelineLayout' ::
	Vk.Dvc.D sd -> Vk.Smplr.S ss -> (forall sdsl sl .
		Vk.DscSetLyt.L sdsl '[
			'Vk.DscSetLyt.Buffer '[VObj.Atom 256 UniformBufferObject 'Nothing],
			'Vk.DscSetLyt.ImageSampler '[ '("texture", 'Vk.T.FormatR8g8b8a8Srgb, ss)] ] ->
		Vk.Ppl.Layout.L sl '[AtomUbo sdsl ss] '[] -> IO b) -> IO b
...
createGraphicsPipeline' :: Vk.Dvc.D sd ->
	Vk.Extent2d -> Vk.RndrPass.R sr -> Vk.Ppl.Layout.L sl '[AtomUbo sdsl ss] '[] ->
...
createDescriptorSet ::
	...
	(forall sds . Vk.DscSet.D sds '(sdsc, '[
		'Vk.DscSetLyt.Buffer '[VObj.Atom 256 UniformBufferObject 'Nothing],
		'Vk.DscSetLyt.ImageSampler '[ '("texture", 'Vk.T.FormatR8g8b8a8Srgb, ss)] ]) -> IO a) -> IO a
...
descriptorWrite1 dscs tiv tsmp = Vk.DscSet.Write {
	...
	Vk.DscSet.writeSources = Vk.DscSet.ImageInfosNoSampler . HeteroParList.Singleton
		$ U3 Vk.Dsc.ImageInfoNoSampler {
			Vk.Dsc.imageInfoNoSamplerImageLayout =
				Vk.Img.LayoutShaderReadOnlyOptimal,
			Vk.Dsc.imageInfoNoSamplerImageView = tiv }
	}
...
recordCommandBuffer :: forall scb sr sf sl sg sm sb nm sm' sb' nm' sdsl sds ss .
	...
	Vk.Ppl.Layout.L sl '[AtomUbo sdsl ss] '[] ->
	Vk.Ppl.Graphics.G sg
		'[ '(Vertex, 'Vk.VtxInp.RateVertex)]
		'[ '(0, Cglm.Vec2), '(1, Cglm.Vec3), '(2, TexCoord)]
		'(sl, '[AtomUbo sdsl ss], '[]) ->
...
mainLoop ::
	...
	Vk.Khr.Swapchain.S ssc scfmt -> Vk.Extent2d ->
	HeteroParList.PL (Vk.ImgVw.I nm scfmt) ss ->
	Vk.RndrPass.R sr -> Vk.Ppl.Layout.L sl '[AtomUbo sdsl ssmp] '[] ->
	Vk.Ppl.Graphics.G sg
		'[ '(Vertex, 'Vk.VtxInp.RateVertex)]
		'[ '(0, Cglm.Vec2), '(1, Cglm.Vec3), '(2, TexCoord)]
...
runLoop ::
	...
	Vk.Khr.Swapchain.S ssc scfmt -> FramebufferResized -> Vk.Extent2d ->
	HeteroParList.PL (Vk.ImgVw.I nm scfmt) sis ->
	Vk.RndrPass.R sr -> Vk.Ppl.Layout.L sl '[AtomUbo sdsl ss] '[] ->
...
drawFrame :: forall sfs sd ssc scfmt sr sl sg sm sb nm sm' sb' nm' sm2 sb2 scb sias srfs siff sdsl sds ss .
	Vk.Dvc.D sd -> Vk.Queue.Q -> Vk.Queue.Q -> Vk.Khr.Swapchain.S ssc scfmt ->
...
recreateSwapChainEtc ::
	...
	Glfw.Window -> Vk.Khr.Surface.S ssfc ->
	Vk.PhDvc.P -> QueueFamilyIndices -> Vk.Dvc.D sd ->
	Vk.Khr.Swapchain.S ssc scfmt -> HeteroParList.PL (Vk.ImgVw.I nm scfmt) sis ->
	Vk.RndrPass.R sr -> Vk.Ppl.Layout.L sl '[AtomUbo sdsl ss] '[] ->
	Vk.Ppl.Graphics.G sg
		'[ '(Vertex, 'Vk.VtxInp.RateVertex)]
		'[ '(0, Cglm.Vec2), '(1, Cglm.Vec3), '(2, TexCoord)]
