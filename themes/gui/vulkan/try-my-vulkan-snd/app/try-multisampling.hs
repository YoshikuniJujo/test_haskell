...
recreateGraphicsPipeline' dvc sce rp ppllyt mss gpls = Vk.Ppl.Graphics.recreateGsOld
...
mkGraphicsPipelineCreateInfo' sce rp ppllyt mss = Vk.Ppl.Graphics.CreateInfoOld {
	...
	Vk.Ppl.Graphics.createInfoMultisampleStateOld = Just $ multisampling mss,
