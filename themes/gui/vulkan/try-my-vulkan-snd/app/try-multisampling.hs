...
recreateGraphicsPipeline' dvc sce rp ppllyt mss gpls = Vk.Ppl.Graphics.recreateGsNew
...
mkGraphicsPipelineCreateInfo' sce rp ppllyt mss = Vk.Ppl.Graphics.CreateInfoNew {
	...
	Vk.Ppl.Graphics.createInfoMultisampleStateNew = Just $ multisampling mss,
	Vk.Ppl.Graphics.createInfoDepthStencilStateNew = Just depthStencil,
...
recordCommandBuffer :: forall scb sr sf sl sg sm sb nm sm' sb' nm' sdsc sp sdsl .
	...
	Vk.Ppl.Layout.LLL sl '[AtomUbo sdsl] '[] ->
	Vk.Ppl.Graphics.G sg
		'[AddType Vertex 'Vk.VtxInp.RateVertex]
		'[ '(0, Pos), '(1, Color), '(2, TexCoord)] ->
	V.Vector Word32 ->
