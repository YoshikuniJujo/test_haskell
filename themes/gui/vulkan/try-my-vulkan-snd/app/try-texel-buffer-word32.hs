...
import qualified Gpu.Vulkan.DescriptorSet.BindingAndArrayElem as Vk.DscSet
...
type MemoryList sm sb nm w =
	Vk.Mem.M sm '[ '( sb, 'Vk.Mem.K.BufferArg nm '[VObj.List 256 w ""])]
...
shaderStageInfo :: Vk.Ppl.ShaderSt.CreateInfoNew 'Nothing 'Nothing 'GlslComputeShader 'Nothing '[Word32, Word32]
...
prepareMems ::
	...
	V.Vector w1 -> V.Vector w2 -> V.Vector w3 -> V.Vector MyPixel -> Word32 -> (
		...
		Vk.Mem.M sm3 '[ '( sb3, 'Vk.Mem.K.BufferArg nm3 '[VObj.List 256 w3 ""])] ->
		IO a) -> IO a
...
storageBufferNew4 :: (Storable w1, Storable w2, Storable w3, Storable w4) =>
	...
	V.Vector w1 -> V.Vector w2 -> V.Vector w3 -> V.Vector w4 -> (
		...
		Vk.Mem.M sm4 '[ '(sb4, 'Vk.Mem.K.BufferArg nm4 '[VObj.List 256 w4 ""])] ->
		IO a ) -> IO a
