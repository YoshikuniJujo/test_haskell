...
pipelineBarrier (CommandBuffer.CC mcb) = pipelineBarrierMiddle mcb

copyBufferToImage ::
	CommandBuffer.CC vs -> Buffer.M.B -> Image.I -> Image.Layout ->
	[Buffer.M.ImageCopy] -> IO ()
copyBufferToImage (CommandBuffer.CC mcb) = copyBufferToImageMiddle mcb

copyImageToBuffer ::
	CommandBuffer.CC vs -> Image.I -> Image.Layout -> Buffer.M.B ->
	[Buffer.M.ImageCopy] -> IO ()
copyImageToBuffer (CommandBuffer.CC mcb) = copyImageToBufferMiddle mcb

blitImage :: CommandBuffer.CC v ->
	Image.I -> Image.Layout -> Image.I -> Image.Layout ->
	[Image.Blit] -> Filter -> IO ()
blitImage (CommandBuffer.CC mcb) = blitImageMiddle mcb
