...
calc dv q cpl dsl dss sz =
	getDataFileName "shader/hello.spv" >>= BS.readFile >>= \(S -> shdr) ->
...
pplInfo :: Vk.PplLyt.P sl sbtss '[] -> S GlslComputeShader ->
...
shdrStInfo :: S GlslComputeShader -> Vk.Ppl.ShaderSt.CreateInfo
	'Nothing 'Nothing 'GlslComputeShader 'Nothing '[]
