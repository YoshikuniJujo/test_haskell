...
createLgDvc pd qfi = Vk.Dvc.create pd info nil
	...
	info = Vk.Dvc.CreateInfo {
		...
		Vk.Dvc.createInfoEnabledFeatures = Just def {
			Vk.Phd.featuresSparseBinding = True,
			Vk.Phd.featuresSparseResidencyImage2D = True
			} }
...
prepareImg pd dv gq w h f = Vk.Img.create @'Nothing dv iinfo nil \i -> do
	...
	Vk.Mm.allocateBind dv (U2 (Vk.Mm.Raw 65536 2293760) :** HPList.Nil) (minfo mt)
		...
		Vk.Q.bindSparse dv gq (HPList.Singleton . U6 $ bindSparseInfoImg w h i mm) Nothing
		f (Vk.Img.unsafeToBinded i)
	where
	iinfo = Vk.Img.CreateInfo {
		Vk.Img.createInfoNext = TMaybe.N,
		Vk.Img.createInfoFlags =
			Vk.Img.CreateSparseBindingBit .|.
			Vk.Img.CreateSparseResidencyBit,
...
bindSparseInfoImg w h img mm = Vk.Q.BindSparseInfo {
	...
	Vk.Q.bindSparseInfoImageBinds =
		HPList.Singleton . U4 $ imgMemoryBindInfo w h img mm,
	Vk.Q.bindSparseInfoSignalSemaphores = HPList.Nil }

imgMemoryBindInfo :: Word32 -> Word32 ->
	Vk.Img.I si inm fmt -> Vk.Mm.M sm ibargs -> 
	Vk.Sp.Img.MemoryBindInfo si inm fmt '[ '(sm, ibargs, 0)]
imgMemoryBindInfo w h img mm = Vk.Sp.Img.MemoryBindInfo {
	Vk.Sp.Img.memoryBindInfoImage = img,
	Vk.Sp.Img.memoryBindInfoBinds =
		HPList.Singleton . U3 $ imgMemoryBind w h mm }

imgMemoryBind :: Word32 -> Word32 ->
	Vk.Mm.M sm ibargs -> Vk.Sp.Img.MemoryBind sm ibargs 0
imgMemoryBind w h mm = Vk.Sp.Img.MemoryBind {
	Vk.Sp.Img.memoryBindSubresource = subresource0,
	Vk.Sp.Img.memoryBindOffset = Vk.Offset3d 0 0 0,
	Vk.Sp.Img.memoryBindExtent = Vk.Extent3d w h 1,
	Vk.Sp.Img.memoryBindMemory = mm,
	Vk.Sp.Img.memoryBindMemoryOffset = 0,
	Vk.Sp.Img.memoryBindFlags = zeroBits }

subresource0 :: Vk.Img.Subresource
subresource0 = Vk.Img.Subresource {
	Vk.Img.subresourceAspectMask = Vk.Img.AspectColorBit,
	Vk.Img.subresourceMipLevel = 0,
	Vk.Img.subresourceArrayLayer = 0 }
