...
body kfs fr w ist =
	...
	getCurrentTime >>=
	mainLoop fr w sfc pd qfis d gq pq sc ex scvs rp pl gpl fbs vb ib ubm ubds cb sos oke prkcs crtx udtx
	where
...
drawFrame :: forall sfs sd ssc scfmt sr sl sg sm sb nm sm' sb' nm' sm2 sb2 scb sdsl sds ssos .
