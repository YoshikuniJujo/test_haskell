...
body txfp mdlfp fr w ist =
	...
	getCurrentTime >>= \tm ->
	mainLoop fr w sfc pd qfis d gq pq sc ex scvs rp pl gp fbs cp drs idcs vb ib cbs sos ubs ums dscss tm
...
createUniformBuffers :: forall ssmp siv sd sdsc a alm .
	KnownNat alm =>
	Vk.Phd.P -> Vk.Dvc.D sd ->
	Vk.DscSetLyt.D sdsc '[
		'Vk.DscSetLyt.Buffer '[VObj.Atom alm WModelViewProj 'Nothing],
