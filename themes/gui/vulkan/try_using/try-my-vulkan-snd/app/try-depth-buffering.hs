...
updateModelViewProj :: forall sd (alm :: Nat) sm nmm . KnownNat alm =>
	Vk.Dvc.D sd ->
...
recordCmdBffr :: forall scb sr sf sl sg sm sb nm sm' sb' nm' sdsl sds alm alv ali nmv nmi . (KnownNat alv, KnownNat ali) =>
	Vk.CBffr.C scb -> Vk.Extent2d ->
	Vk.RndrPss.R sr ->
