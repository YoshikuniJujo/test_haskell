...
updateModelViewProj :: forall sd sm sb alm bnmm . KnownNat alm =>
	Vk.Dvc.D sd ->
...
updateModelViewProj dvc um sce tm = do
...
recordCmdBffr :: forall scb sr sf sl sg sm sb nm sm' sb' nm' sdsl sds alm alv ali nmi nmv .
