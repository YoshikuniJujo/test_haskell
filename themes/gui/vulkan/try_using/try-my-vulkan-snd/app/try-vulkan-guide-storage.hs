...
import qualified Gpu.Vulkan.Pipeline.VertexInputStateNew as Vk.Ppl.VtxIptSt
...
import qualified "try-gpu-vulkan" Gpu.Vulkan.Fence.Enum as Vk.Fnc
...
createObjDataBuffer pd dv = createBuffer pd dv
	(HL.Singleton $ Obj.LengthList maxObjects)
