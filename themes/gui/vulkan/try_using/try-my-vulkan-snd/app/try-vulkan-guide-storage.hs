...
import Tools (clampOld, pattern (:-), cycleI, findPlusM, findBySnd)
...
body :: FilePath -> Natural -> FramebufferResized -> GlfwG.Win.W sw -> Vk.Ist.I s -> IO ()
body mdlfp mff rszd (GlfwG.Win.W w) ist =
