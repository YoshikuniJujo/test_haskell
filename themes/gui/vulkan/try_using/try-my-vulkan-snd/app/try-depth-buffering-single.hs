...
body txfp fr w ist =
	...
	getCurrentTime >>= \tm ->
	mainLoop fr w sfc pd qfis d gq pq sc ex scvs rp pl gp fbs cp di dm dv vb ib mbm ubds cb sos tm
...
mainLoop :: (
	...
	Vk.T.FormatToValue scfmt, Vk.T.FormatToValue dptfmt, KnownNat alm, KnownNat alv, KnownNat ali ) =>
	FramebufferResized ->
