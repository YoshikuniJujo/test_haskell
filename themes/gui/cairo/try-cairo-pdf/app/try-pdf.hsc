...
--	cairoTagBegin cr #{const_str CAIRO_TAG_LINK} "page=2 pos=[3.1 6.2]"
--	cairoTagBegin cr #{const_str CAIRO_TAG_LINK} "page=1 pos=[100 800]"
	cairoTagBegin cr #{const_str CAIRO_TAG_LINK} $ "page=" ++ show p ++ " pos=[100 800]"
