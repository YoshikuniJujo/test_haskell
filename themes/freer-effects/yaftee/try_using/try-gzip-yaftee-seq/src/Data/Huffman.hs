...
decodeBitArray p t0 t ba = case BitArray.pop ba of
	Nothing -> (([], t), (BitArray.fromSequence Seq.Empty, False))
...
decode1 :: BinTree a -> BinTree a -> B -> (Maybe a, BinTree a)
