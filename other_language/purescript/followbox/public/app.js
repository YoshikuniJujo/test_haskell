...
(function($PS) {
  ...
  var followbox = Halogen_Component.mkComponent({
      ...
      "eval": Halogen_Component.mkEval({
          handleAction: function (v1) {
              return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v1);
          },
  ...
  var main = Halogen_Aff_Util.runHalogenAff(Control_Bind.bind(Effect_Aff.bindAff)(Halogen_Aff_Util.awaitBody)(function (body) {
      return Halogen_VDom_Driver.runUI(followbox)(Data_Unit.unit)(body);
  }));
  exports["main"] = main;
  exports["followbox"] = followbox;
})(PS);
PS["Main"].main();