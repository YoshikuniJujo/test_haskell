...
module GHC.JS.Value.GpuAdapterInfo where
...
architecture :: G -> String
architecture (G g) = fromJSString $ js_architecture g

foreign import javascript
	"((g) => { return g.architecture; })"
	js_architecture :: JSVal -> JSVal
